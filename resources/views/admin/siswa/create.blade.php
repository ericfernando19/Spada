            ...
            <div class="max-w-7xl mx-auto">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <div class="text-center md:text-left mb-4 md:mb-0">
                        <h1 class="text-3xl font-bold">Tambah Data Siswa</h1>
                        <p class="mt-2 text-blue-100">Tambah siswa baru ke dalam sistem</p>
                    </div>
                    <div class="flex items-center space-x-4 bg-white/10 backdrop-blur-sm rounded-xl p-3">
                        ...
                        <div>
                            <p class="font-semibold">{{ $user->nama ?? 'Admin' }}</p>
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover">
                ...
                <div class="border-b border-gray-100 p-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-gray-800">Form Tambah Siswa</h2>
                            <p class="text-gray-600 text-sm">Isi data lengkap siswa baru</p>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ route('siswa.store') }}" method="POST" class="p-6">
                    ...
                    <div class="form-section">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="font-semibold text-gray-800">Kontak & Kelas</h3>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <ul class="text-blue-700 text-sm mt-1 list-disc list-inside space-y-1">
                                    <li>Pastikan NISN sudah benar dan belum terdaftar</li>
                                    <li>No HP digunakan untuk komunikasi penting dengan orang tua/wali</li>
                                    <li>Format kelas: Contoh: "X IPA 1" atau "XI IPS 2"</li>
                                    <li>Data yang sudah disimpan tidak dapat diubah dengan mudah</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-800">{{ $totalKelas ?? '8' }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
