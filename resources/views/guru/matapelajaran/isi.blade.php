            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editMateriModal{{ $m->id }}">✏️ Edit Materi</button></li>
                        ...
                        <div class="border rounded p-3 mb-3 bg-white">
                            <div class="d-flex justify-content-between align-items-start">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editSubMateriModal{{ $sub->id }}">✏️ Edit Submateri</button></li>
                                        <li><button class="dropdown-item text-danger" onclick="hapusSubMateri('{{ route('submateri.destroy', $sub->id) }}')">🗑️ Hapus Submateri</button></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li><button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#tambahTugasModal{{ $sub->id }}">📝 Tambah Tugas</button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
